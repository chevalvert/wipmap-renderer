  ...
  processBiomesTextureSprites (renderQueue = [], opts) {
    Object.entries(this.map.points).forEach(([type, points]) => {
      ...
      points.forEach(point => {
        ...
        sprites.forEach(([name, probability, scale, opacity]) => {
